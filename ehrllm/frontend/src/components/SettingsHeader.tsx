...
import { MODEL_2_DISPLAY_NAME } from "@/utils/utils"
        ...
        <div className="flex justify-between">
            <div className="flex gap-2">
                <Button 
                    variant="ghost" 
                    size="sm" 
                    onClick={() => setMode('clinicalTrialRecruitment')}
                    className={`${settings.database === 'n2c2-2018' ? 'bg-gray-100' : ''}`}
                >
                ...
                <Button 
                    variant="ghost" 
                    size="sm" 
                    onClick={() => setMode('chartAbstraction')}
                    className={`${settings.database === 'mimiciv-notes' ? 'bg-gray-100' : ''}`}
                >
                    Chart Abstraction
                </Button>
            </div>
